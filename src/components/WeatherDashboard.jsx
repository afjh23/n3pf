...
export const WeatherDashboard = () => {
  ...
  console.log(unit)
  return (
    <main className='relative w-screen h-[1718px] bg-[#100E1D] font-PrincipalFont text-[#E7E7EB] flex flex-col items-center
    sm:w-full sm:h-screen sm:flex sm:flex-col sm:justify-center sm:items-center sm:gap-4 2xl:gap-16'>
      <div className='absolute top-0 gap-2 mt-0.5 2xl:mt-4 font-bold text-lg w-full max-w-[722px] sm:mb-0 2xl:mb-4 justify-end hidden sm:flex sm:flex-row'>
